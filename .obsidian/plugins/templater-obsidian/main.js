...
var En = (r) => ir(r, "__esModule", { value: !0 });
var Vi = (r, e) => {
    En(r);
    for (var t in e) ir(r, t, { get: e[t], enumerable: !0 });
  },
  Wi = (r, e, t) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (let n of Li(e))
        !Gi.call(r, n) &&
          ...
          ir(r, n, {
            get: () => e[n],
            enumerable: !(t = Yi(e, n)) || t.enumerable,
          });
    return r;
  },
  V = (r) =>
...
Vi(exports, { default: () => fn });
var jr = V(require("obsidian"));
var I = V(require("obsidian"));
var Tn = V(require("obsidian"));
function K(r) {
  let e = new Tn.Notice("", 8e3);
...
`,
    ...
    : (e.noticeEl.innerHTML = `<b>Templater Error</b>:<br/>${r.message}`);
}
...
async function Oe(r, e) {
  try {
    ...
    return t instanceof w ? K(t) : K(new w(e, t.message)), null;
  }
}
function me(r, e) {
  try {
    ...
    return K(new w(e, t.message)), null;
  }
}
var Xn = V(require("obsidian"));
var zn = V(require("obsidian"));
var W = "top",
  Z = "bottom",
  Q = "right",
  U = "left",
  ...
  wt = "popper",
  Mn = "reference",
  xr = Ze.reduce(function (r, e) {
    return r.concat([e + "-" + We, e + "-" + at]);
  }, []),
  ar = [].concat(Ze, [or]).reduce(function (r, e) {
    return r.concat([e, e + "-" + We, e + "-" + at]);
  }, []),
  Ki = "beforeRead",
  Ui = "read",
  zi = "afterRead",
...
function ee(r) {
  var e = Y(r).HTMLElement;
  return r instanceof e || r instanceof HTMLElement;
}
function bt(r) {
  if (typeof ShadowRoot == "undefined") return !1;
  var e = Y(r).ShadowRoot;
...
function je(r, e, t) {
  ...
  e &&
    ee(r) &&
    ((o = (r.offsetWidth > 0 && Ke(n.width) / r.offsetWidth) || 1),
    (s = (r.offsetHeight > 0 && Ke(n.height) / r.offsetHeight) || 1));
  var l = he(r) ? Y(r) : window,
    p = l.visualViewport,
    A = !qt() && t,
    g = (n.left + (A && p ? p.offsetLeft : 0)) / o,
    f = (n.top + (A && p ? p.offsetTop : 0)) / s,
    b = n.width / o,
    k = n.height / s;
  return {
    width: b,
...
function ct(r) {
  ...
  return (
    ...
    { x: r.offsetLeft, y: r.offsetTop, width: t, height: n }
  );
}
function It(r, e) {
...
function Er(r) {
  return ["table", "td", "th"].indexOf(te(r)) >= 0;
}
function ne(r) {
  return ((he(r) ? r.ownerDocument : r.document) || window.document)
    .documentElement;
}
function Ue(r) {
  return te(r) === "html"
    ? r
    : r.assignedSlot || r.parentNode || (bt(r) ? r.host : null) || ne(r);
}
function On(r) {
  return !ee(r) || Ae(r).position === "fixed" ? null : r.offsetParent;
}
function io(r) {
  ...
  var o = Ue(r);
  for (bt(o) && (o = o.host); ee(o) && ["html", "body"].indexOf(te(o)) < 0; ) {
    var s = Ae(o);
    if (
      s.transform !== "none" ||
      s.perspective !== "none" ||
...
function xe(r) {
  for (var e = Y(r), t = On(r); t && Er(t) && Ae(t).position === "static"; )
    t = On(t);
  return t &&
    (te(t) === "html" || (te(t) === "body" && Ae(t).position === "static"))
    ? e
    : t || io(r) || e;
}
function At(r) {
...
function so(r) {
  var e,
    ...
    f = g ? "height" : "width";
  if (!(!s || !l)) {
    var b = oo(o.padding, t),
      k = ct(s),
      x = A === "y" ? W : U,
      O = A === "y" ? Z : Q,
      M =
        t.rects.reference[f] + t.rects.reference[A] - l[A] - t.rects.popper[f],
      j = l[A] - t.rects.reference[A],
      P = xe(s),
      L = P ? (A === "y" ? P.clientHeight || 0 : P.clientWidth || 0) : 0,
      N = M / 2 - j / 2,
      T = b[x],
      S = L - k[f] - b[O],
      q = L / 2 - k[f] / 2 + N,
      R = pt(T, q, S),
      z = A;
    t.modifiersData[n] = ((e = {}), (e[z] = R), (e.centerOffset = R - q), e);
  }
}
function ao(r) {
  var e = r.state,
...
function co(r, e) {
  ...
  return { x: Ke(t * o) / o || 0, y: Ke(n * o) / o || 0 };
}
function Sn(r) {
  var e,
    t = r.popper,
    ...
    O = l.y,
    M = O === void 0 ? 0 : O,
    j = typeof f == "function" ? f({ x, y: M }) : { x, y: M };
  (x = j.x), (M = j.y);
  ...
  if (g) {
    ...
    if (
      ...
      T = Z;
      var J = b && q === S && S.visualViewport ? S.visualViewport.height : q[R];
      (M -= J - n.height), (M *= A ? 1 : -1);
    }
    if (o === U || ((o === W || o === Z) && s === at)) {
      N = Q;
      var G = b && q === S && S.visualViewport ? S.visualViewport.width : q[z];
      (x -= G - n.width), (x *= A ? 1 : -1);
    }
  }
  var m = Object.assign({ position: p }, g && lo),
    h = f === !0 ? co({ x, y: M }, Y(t)) : { x, y: M };
  if (((x = h.x), (M = h.y), A)) {
    var c;
...
function po(r) {
  var e = r.state,
    ...
    l = n.resize,
    p = l === void 0 ? !0 : l,
    A = Y(e.elements.popper),
    g = [].concat(e.scrollParents.reference, e.scrollParents.popper);
  return (
    s &&
      g.forEach(function (f) {
        f.addEventListener("scroll", t.update, lr);
      }),
    p && A.addEventListener("resize", t.update, lr),
    function () {
      s &&
        g.forEach(function (f) {
          f.removeEventListener("scroll", t.update, lr);
        }),
        p && A.removeEventListener("resize", t.update, lr);
    }
  );
}
var Dn = {
...
function mt(r) {
  return je(ne(r)).left + ut(r).scrollLeft;
}
function kr(r, e) {
  var t = Y(r),
    n = ne(r),
  ...
  if (o) {
    ...
    var g = qt();
    (g || (!g && e === "fixed")) && ((p = o.offsetLeft), (A = o.offsetTop));
  }
  return { width: s, height: l, x: p + mt(r), y: A };
}
function Tr(r) {
  var e,
    t = ne(r),
    n = ut(r),
    o = (e = r.ownerDocument) == null ? void 0 : e.body,
    s = ye(
      t.scrollWidth,
      t.clientWidth,
      o ? o.scrollWidth : 0,
  ...
  return (
    Ae(o || t).direction === "rtl" &&
      (p += ye(t.clientWidth, o ? o.clientWidth : 0) - s),
    { width: s, height: l, x: p, y: A }
  );
}
function ft(r) {
  var e = Ae(r),
...
function Ar(r) {
  return ["html", "body", "#document"].indexOf(te(r)) >= 0
...
function et(r, e) {
  ...
  e === void 0 && (e = []);
  var n = Ar(r),
    o = n === ((t = r.ownerDocument) == null ? void 0 : t.body),
    s = Y(n),
    l = o ? [s].concat(s.visualViewport || [], ft(n) ? n : []) : n,
    p = e.concat(l);
  return o ? p : p.concat(et(Ue(l)));
}
function Et(r) {
...
function $n(r, e, t) {
  return e === sr ? Et(kr(r, t)) : he(e) ? fo(e, t) : Et(Tr(ne(r)));
}
function go(r) {
  var e = et(Ue(r)),
  ...
  return he(n)
    ? e.filter(function (o) {
        return he(o) && It(o, n) && te(o) !== "body";
      })
    : [];
}
function Fr(r, e, t, n) {
  var o = e === "clippingParents" ? go(r) : [].concat(e),
    s = [].concat(o, [t]),
    l = s[0],
    p = s.reduce(
      function (A, g) {
        var f = $n(r, g, n);
        return (
          (A.top = ye(f.top, A.top)),
          (A.right = lt(f.right, A.right)),
          (A.bottom = lt(f.bottom, A.bottom)),
          (A.left = ye(f.left, A.left)),
          A
        );
      },
      $n(r, l, n),
...
function Ee(r, e) {
  ...
  var t = e,
    n = t.placement,
    o = n === void 0 ? r.placement : n,
    s = t.strategy,
    l = s === void 0 ? r.strategy : s,
    p = t.boundary,
    A = p === void 0 ? Fn : p,
    g = t.rootBoundary,
    f = g === void 0 ? sr : g,
    ...
    M = t.padding,
    j = M === void 0 ? 0 : M,
    P = Ct(typeof j != "number" ? j : Dt(j, Ze)),
    L = k === wt ? Mn : wt,
    N = r.rects.popper,
    T = r.elements[O ? L : k],
    S = Fr(he(T) ? T : T.contextElement || ne(r.elements.popper), A, f, l),
    q = je(r.elements.reference),
    R = $t({ reference: q, element: N, strategy: "absolute", placement: o }),
    z = Et(Object.assign({}, N, R)),
    J = k === wt ? z : q,
    G = {
      top: S.top - J.top + P.top,
      bottom: J.bottom - S.bottom + P.bottom,
      left: S.left - J.left + P.left,
      right: J.right - S.right + P.right,
    },
    m = r.modifiersData.offset;
  if (k === wt && m) {
    var h = m[o];
    Object.keys(G).forEach(function (c) {
      var we = [Q, Z].indexOf(c) >= 0 ? 1 : -1,
        ue = [W, Z].indexOf(c) >= 0 ? "y" : "x";
      G[c] += h[ue] * we;
    });
  }
  return G;
...
function Mr(r, e) {
  ...
  var t = e,
    ...
    b = f
      ? p
        ? xr
        : xr.filter(function (O) {
            return _e(O) === f;
          })
      : Ze,
    k = b.filter(function (O) {
      return g.indexOf(O) >= 0;
    });
  k.length === 0 && (k = b);
  var x = k.reduce(function (O, M) {
    return (
      (O[M] = Ee(r, { placement: M, boundary: o, rootBoundary: s, padding: l })[
        re(M)
      ]),
      O
    );
  }, {});
  return Object.keys(x).sort(function (O, M) {
    return x[O] - x[M];
  });
}
function ho(r) {
        ...
        var gt = O ? 3 : 1,
          Me = function (_) {
            var F = T.find(function (H) {
              var Re = R.get(H);
              if (Re)
                return Re.slice(0, _).every(function (C) {
                  return C;
                });
            });
...
function Yn(r) {
  return [W, Q, Z, U].some(function (e) {
    return r[e] >= 0;
  });
}
function _o(r) {
  var e = r.state,
    ...
    l = Ee(e, { elementContext: "reference" }),
    p = Ee(e, { altBoundary: !0 }),
    A = Rn(l, n),
    g = Rn(p, o, s),
    f = Yn(A),
    b = Yn(g);
...
function vo(r, e, t) {
  ...
  return (
    (l = l || 0),
    (p = (p || 0) * o),
    [U, Q].indexOf(n) >= 0 ? { x: p, y: l } : { x: l, y: p }
  );
}
function wo(r) {
  var e = r.state,
    ...
    o = t.offset,
    s = o === void 0 ? [0, 0] : o,
    l = ar.reduce(function (f, b) {
      return (f[b] = vo(b, e.rects, s)), f;
    }, {}),
    p = l[e.placement],
    A = p.x,
    g = p.y;
  e.modifiersData.popperOffsets != null &&
    ...
    (e.modifiersData.popperOffsets.y += g)),
    (e.modifiersData[n] = l);
}
var Hn = {
  name: "offset",
...
function yo(r) {
  var e = r.state,
    ...
    O = t.tetherOffset,
    M = O === void 0 ? 0 : O,
    j = Ee(e, { boundary: A, rootBoundary: g, padding: b, altBoundary: f }),
    P = re(e.placement),
    L = _e(e.placement),
    N = !L,
    T = At(P),
  ...
  if (!!q) {
    if (s) {
      var c,
        ...
        H = _[ue],
        Re = pt(0, R[oe], y[oe]),
        C = N ? R[oe] / 2 - gt - Re - F - G.mainAxis : Me - Re - F - G.mainAxis,
        le = N
          ? -R[oe] / 2 + gt + Re + H + G.mainAxis
          : Ne + Re + H + G.mainAxis,
        nt = e.elements.arrow && xe(e.elements.arrow),
        Kt = nt ? (T === "y" ? nt.clientTop || 0 : nt.clientLeft || 0) : 0,
        Ye = (c = m == null ? void 0 : m[T]) != null ? c : 0,
        Le = se + C - Ye - Kt,
        Je = se + le - Ye,
        it = pt(x ? lt(Fe, Le) : Fe, se, x ? ye(fe, Je) : fe);
      (q[T] = it), (h[T] = it - se);
    }
    if (p) {
      var Ut,
        ...
        Qt = He - j[Jt],
        Mt = [W, U].indexOf(P) !== -1,
        ot = (Ut = m == null ? void 0 : m[S]) != null ? Ut : 0,
        Zt = Mt ? Xt : He - R[ht] - z[ht] - ot + G.altAxis,
        Pe = Mt ? He + R[ht] + z[ht] - ot - G.altAxis : Qt,
        X = x && Mt ? qn(Zt, He, Pe) : pt(x ? Zt : Xt, He, x ? Pe : Qt);
      (q[S] = X), (h[S] = X - He);
    }
    e.modifiersData[n] = h;
  }
...
function Or(r) {
  return r === Y(r) || !ee(r) ? ut(r) : Br(r);
}
function xo(r) {
  var e = r.getBoundingClientRect(),
    t = Ke(e.width) / r.offsetWidth || 1,
    n = Ke(e.height) / r.offsetHeight || 1;
  return t !== 1 || n !== 1;
}
function qr(r, e, t) {
  t === void 0 && (t = !1);
  ...
  return (
    (n || (!n && !t)) &&
      ((te(e) !== "body" || ft(s)) && (p = Or(e)),
      ee(e)
        ? ((A = je(e, !0)), (A.x += e.clientLeft), (A.y += e.clientTop))
        : s && (A.x = mt(s))),
    {
      x: l.left + p.scrollLeft - A.x,
      y: l.top + p.scrollTop - A.y,
      width: l.width,
      height: l.height,
    }
  );
...
var Wn = { placement: "bottom", modifiers: [], strategy: "absolute" };
function Kn() {
...
function Un(r) {
  ...
  return function (p, A, g) {
    ...
    var f = {
      ...
      x = {
        ...
        setOptions: function (P) {
          var L = typeof P == "function" ? P(f.options) : P;
          M(),
            (f.options = Object.assign({}, s, f.options, L)),
            (f.scrollParents = {
              reference: he(p)
                ? et(p)
                : p.contextElement
          ...
          var N = Ir(Cr([].concat(n, f.options.modifiers)));
          return (
        ...
        forceUpdate: function () {
          if (!k) {
            ...
            if (!!Kn(L, N)) {
              (f.rects = {
                reference: qr(L, xe(N), f.options.strategy === "fixed"),
                popper: ct(N),
              }),
                (f.reset = !1),
              ...
              for (var T = 0; T < f.orderedModifiers.length; T++) {
                ...
                var S = f.orderedModifiers[T],
                  q = S.fn,
                  R = S.options,
                  z = R === void 0 ? {} : R,
                  J = S.name;
                typeof q == "function" &&
                  (f = q({ state: f, options: z, name: J, instance: x }) || f);
              }
            }
          }
        },
    ...
    if (!Kn(p, A)) return x;
    x.setOptions(g).then(function (j) {
      !k && g.onFirstUpdate && g.onFirstUpdate(j);
    });
    function O() {
      f.orderedModifiers.forEach(function (j) {
        ...
        if (typeof T == "function") {
          var S = T({ state: f, name: P, instance: x, options: N }),
            q = function () {};
          b.push(S || q);
        }
      });
...
var ko = [Dn, Gn, Cn, Bn, Hn, Nn, Vn, In, Ln],
  Dr = Un({ defaultModifiers: ko });
var To = (r, e) => ((r % e) + e) % e,
  Jn = class {
    constructor(e, t, n) {
      (this.owner = e),
        ...
        n.register([], "Enter", (o) => {
          if (!o.isComposing) return this.useSelectedItem(o), !1;
        });
    }
    ...
    setSelectedItem(e, t) {
      let n = To(e, this.suggestions.length),
        o = this.suggestions[this.selectedItem],
        s = this.suggestions[n];
      o?.removeClass("is-selected"),
        s?.addClass("is-selected"),
        (this.selectedItem = n),
        t && s.scrollIntoView(!1);
    }
  },
  Nt = class {
    constructor(e) {
      (this.inputEl = e),
        (this.scope = new zn.Scope()),
        (this.suggestEl = createDiv("suggestion-container"));
      let t = this.suggestEl.createDiv("suggestion");
      (this.suggest = new Jn(this, t, this.scope)),
    ...
    open(e, t) {
      app.keymap.pushScope(this.scope),
        ...
        (this.popper = Dr(t, this.suggestEl, {
...
var Rt = class extends Nt {
  getSuggestions(e) {
    let t = app.vault.getAllLoadedFiles(),
      n = [],
      o = e.toLowerCase();
    return (
      t.forEach((s) => {
        s instanceof Xn.TFolder &&
...
var ti = V(require("obsidian"));
var qe = V(require("obsidian"));
function pr(r) {
...
function Fo(r) {
  r = (0, qe.normalizePath)(r);
  let e = app.vault.getAbstractFileByPath(r);
  if (!e) throw new w(`Folder "${r}" doesn't exist`);
  if (!(e instanceof qe.TFolder)) throw new w(`${r} is a file, not a folder`);
  return e;
}
function Yt(r) {
  r = (0, qe.normalizePath)(r);
  let e = app.vault.getAbstractFileByPath(r);
  if (!e) throw new w(`File "${r}" doesn't exist`);
  if (!(e instanceof qe.TFile)) throw new w(`${r} is a folder, not a file`);
  return e;
}
function Ie(r) {
  let e = Fo(r),
    t = [];
  return (
    qe.Vault.recurseChildren(e, (n) => {
      n instanceof qe.TFile && t.push(n);
    }),
    t.sort((n, o) => n.path.localeCompare(o.path)),
    t
  );
}
function Lt(r, e, t) {
...
var ri = {
  ...
  $r = class extends I.PluginSettingTab {
    constructor(e) {
      super(app, e);
      this.plugin = e;
    }
    ...
    add_template_folder_setting() {
      new I.Setting(this.containerEl)
        ...
        new I.Setting(this.containerEl)
          ...
          .addToggle((n) => {
            n.setValue(this.plugin.settings.syntax_highlighting).onChange(
              (o) => {
                (this.plugin.settings.syntax_highlighting = o),
                  this.plugin.save_settings(),
        ...
        new I.Setting(this.containerEl)
          ...
          .addToggle((n) => {
            n.setValue(
              ...
              (this.plugin.settings.syntax_highlighting_mobile = o),
                this.plugin.save_settings(),
                this.plugin.event_handler.update_syntax_highlighting();
            });
          });
    ...
    add_templates_hotkeys_setting() {
      new I.Setting(this.containerEl).setName("Template hotkeys").setHeading();
      let e = document.createDocumentFragment();
      e.append("Template hotkeys allows you to bind a template to a hotkey."),
        new I.Setting(this.containerEl).setDesc(e),
        this.plugin.settings.enabled_templates_hotkeys.forEach((t, n) => {
          new I.Setting(this.containerEl)
            .addSearch((s) => {
              new Ht(s.inputEl, this.plugin, Se.TemplateFiles),
                s
                  ...
                  .onChange((l) => {
                    if (
                      l &&
                      this.plugin.settings.enabled_templates_hotkeys.contains(l)
                    ) {
                      K(new w("This template is already bound to a hotkey"));
                      return;
                    }
                    this.plugin.command_handler.add_template_hotkey(
                      ...
                      (this.plugin.settings.enabled_templates_hotkeys[n] = l),
                      this.plugin.save_settings();
                  }),
                s.containerEl.addClass("templater_search");
            })
            .addExtraButton((s) => {
              s.setIcon("any-key")
                ...
                .onClick(() => {
                  ...
                  let l = app.setting.activeTab;
                  (l.searchInputEl.value = "Templater: Insert"),
                    l.updateHotkeyVisibility();
                });
            })
            .addExtraButton((s) => {
              s.setIcon("up-chevron-glyph")
                .setTooltip("Move up")
                .onClick(() => {
                  Lt(this.plugin.settings.enabled_templates_hotkeys, n, n - 1),
                    this.plugin.save_settings(),
                    this.display();
                });
            })
            .addExtraButton((s) => {
              s.setIcon("down-chevron-glyph")
        ...
        new I.Setting(this.containerEl).addButton((t) => {
      ...
      t.append(
        ...
        new I.Setting(this.containerEl)
          ...
          .addToggle((n) => {
            n.setValue(this.plugin.settings.enable_folder_templates).onChange(
              (o) => {
                (this.plugin.settings.enable_folder_templates = o),
                  this.plugin.save_settings(),
                  this.display();
              },
            );
        ...
        !!this.plugin.settings.enable_folder_templates &&
          (new I.Setting(this.containerEl)
            ...
            .addButton((n) => {
              n.setTooltip("Add additional folder template")
                .setButtonText("+")
                .setCta()
                .onClick(() => {
          ...
          this.plugin.settings.folder_templates.forEach((n, o) => {
            new I.Setting(this.containerEl)
              .addSearch((l) => {
                new Rt(l.inputEl),
                  l
                    ...
                    .onChange((p) => {
                      ...
                      (this.plugin.settings.folder_templates[o].folder = p),
                        this.plugin.save_settings();
                    }),
                  l.containerEl.addClass("templater_search");
              })
              .addSearch((l) => {
                new Ht(l.inputEl, this.plugin, Se.TemplateFiles),
                  l
                    .setPlaceholder("Template")
                    .setValue(n.template)
                    .onChange((p) => {
                      (this.plugin.settings.folder_templates[o].template = p),
                        this.plugin.save_settings();
                    }),
                  l.containerEl.addClass("templater_search");
              })
              .addExtraButton((l) => {
                l.setIcon("up-chevron-glyph")
                  .setTooltip("Move up")
                  .onClick(() => {
                    Lt(this.plugin.settings.folder_templates, o, o - 1),
                      this.plugin.save_settings(),
                      this.display();
                  });
              })
              .addExtraButton((l) => {
                l.setIcon("down-chevron-glyph")
                  .setTooltip("Move down")
                  .onClick(() => {
                    Lt(this.plugin.settings.folder_templates, o, o + 1),
                      this.plugin.save_settings(),
              ...
              .addExtraButton((l) => {
                l.setIcon("cross")
                  .setTooltip("Delete")
                  .onClick(() => {
                    this.plugin.settings.folder_templates.splice(o, 1),
                      this.plugin.save_settings(),
                      this.display();
                  });
              })
    ...
    add_startup_templates_setting() {
      new I.Setting(this.containerEl).setName("Startup templates").setHeading();
      let e = document.createDocumentFragment();
      e.append(
              ...
              new Ht(s.inputEl, this.plugin, Se.TemplateFiles),
                s
                  ...
                  .onChange((l) => {
                    if (
                      l &&
                      this.plugin.settings.startup_templates.contains(l)
                    ) {
                      K(new w("This startup template already exist"));
                      return;
                    }
                    (this.plugin.settings.startup_templates[n] = l),
                      this.plugin.save_settings();
                  }),
                s.containerEl.addClass("templater_search");
            })
    ...
    add_user_script_functions_setting() {
          ...
          .addSearch((n) => {
            new Rt(n.inputEl),
              n
                ...
                .onChange((o) => {
                  (this.plugin.settings.user_scripts_folder = o),
                    this.plugin.save_settings();
                }),
      ...
      if (!this.plugin.settings.user_scripts_folder)
        ...
        let n = me(
          () => Ie(this.plugin.settings.user_scripts_folder),
      ...
      if (
        ...
        new I.Setting(this.containerEl)
          ...
          .addText((s) => {
            s.setPlaceholder("Timeout")
              ...
              .onChange((l) => {
                ...
                (this.plugin.settings.command_timeout = p),
                  this.plugin.save_settings();
              });
          }),
          (e = document.createDocumentFragment()),
          ...
          new I.Setting(this.containerEl)
            ...
            .setDesc(e)
            .addText((s) => {
              s.setPlaceholder("Example: /bin/bash, ...")
                .setValue(this.plugin.settings.shell_path)
                .onChange((l) => {
                  (this.plugin.settings.shell_path = l),
                    this.plugin.save_settings();
                });
            });
        let t = 1;
        this.plugin.settings.templates_pairs.forEach((s) => {
          let l = this.containerEl.createEl("div");
          l.addClass("templater_div");
          let p = this.containerEl.createEl("h4", {
            text: "User function n\xB0" + t,
          });
          p.addClass("templater_title"),
            new I.Setting(this.containerEl)
              .addExtraButton((g) => {
                g.setIcon("cross")
                  .setTooltip("Delete")
              ...
              .addTextArea((g) => {
                ...
                return (
                  f.inputEl.setAttr("rows", 2),
                  f.inputEl.addClass("templater_cmd"),
                  f
                );
              })
              .infoEl.remove(),
            l.appendChild(p),
            l.appendChild(this.containerEl.lastChild),
            (t += 1);
        });
        ...
        n.addClass("templater_div2"),
          new I.Setting(this.containerEl)
            .addButton((s) => {
              s.setButtonText("Add new user function")
                .setCta()
                .onClick(() => {
    ...
    add_donating_setting() {
      let e = new I.Setting(this.containerEl)
          .setName("Donate")
          .setDesc(
      ...
      (s.src =
        ...
        e.settingEl.appendChild(o);
    }
  };
var ni = V(require("obsidian"));
var Tt;
(function (t) {
  (t[(t.InsertTemplate = 0)] = "InsertTemplate"),
    (t[(t.CreateNoteTemplate = 1)] = "CreateNoteTemplate");
})(Tt || (Tt = {}));
var Nr = class extends ni.FuzzySuggestModal {
  constructor(e) {
    super(app);
  ...
  getItems() {
    ...
    let e = me(
      () => Ie(this.plugin.settings.templates_folder),
  ...
  getItemText(e) {
    ...
    return (
      e.path.startsWith(this.plugin.settings.templates_folder) &&
        (t = e.path.slice(this.plugin.settings.templates_folder.length + 1)),
...
var ii = "Error_MobileUnsupportedTemplate",
  oi =
...
var Rr = class extends pe {
  ...
  async teardown() {}
  generate_now() {
    return (e = "YYYY-MM-DD", t, n, o) => {
      if (n && !window.moment(n, o).isValid())
        throw new w(
      ...
      return (
        typeof t == "string"
          ? (s = window.moment.duration(t))
          : typeof t == "number" && (s = window.moment.duration(t, "days")),
        window.moment(n, o).add(s).format(e)
      );
    };
  }
  generate_tomorrow() {
    return (e = "YYYY-MM-DD") => window.moment().add(1, "days").format(e);
  }
  generate_weekday() {
    return (e = "YYYY-MM-DD", t, n, o) => {
      if (n && !window.moment(n, o).isValid())
      ...
      return window.moment(n, o).weekday(t).format(e);
    };
  }
  generate_yesterday() {
    return (e = "YYYY-MM-DD") => window.moment().add(-1, "days").format(e);
...
var si = 10,
  Yr = class extends pe {
    ...
    generate_create_new() {
      return async (e, t, n = !1, o) => {
        if (((this.create_new_depth += 1), this.create_new_depth > si))
          throw (
            ((this.create_new_depth = 0),
        ...
        return (this.create_new_depth -= 1), s;
      };
    }
    generate_creation_date() {
      return (e = "YYYY-MM-DD HH:mm") =>
        window.moment(this.config.target_file.stat.ctime).format(e);
    }
    generate_cursor() {
    ...
    generate_cursor_append() {
      return (e) => {
        let t = app.workspace.activeEditor;
        if (!t || !t.editor) {
    ...
    generate_exists() {
      return async (e) => {
        let t = (0, ie.normalizePath)(e);
        return await app.vault.exists(t);
      };
    }
    generate_find_tfile() {
      return (e) => {
        let t = (0, ie.normalizePath)(e);
        return app.metadataCache.getFirstLinkpathDest(t, "");
      };
    }
    generate_folder() {
      return (e = !1) => {
    ...
    generate_include() {
      return async (e) => {
        if (((this.include_depth += 1), this.include_depth > si))
          throw (
            ((this.include_depth -= 1),
            new w("Reached inclusion depth limit (max = 10)"))
          );
        let t;
        if (e instanceof ie.TFile) t = await app.vault.read(e);
        else {
          let n;
          ...
          let { path: o, subpath: s } = (0, ie.parseLinktext)(n[1]),
            l = app.metadataCache.getFirstLinkpathDest(o, "");
          if (!l)
            throw ((this.include_depth -= 1), new w(`File ${e} doesn't exist`));
          if (((t = await app.vault.read(l)), s)) {
            let p = app.metadataCache.getFileCache(l);
            if (p) {
              let A = (0, ie.resolveSubpath)(p, s);
              A && (t = t.slice(A.start.offset, A.end?.offset));
            }
          }
        }
        try {
    ...
    generate_last_modified_date() {
      return (e = "YYYY-MM-DD HH:mm") =>
        window.moment(this.config.target_file.stat.mtime).format(e);
    }
    generate_move() {
      return async (e, t) => {
        let n = t || this.config.target_file,
          o = (0, ie.normalizePath)(`${e}.${n.extension}`),
          s = o.replace(/\\/g, "/").split("/");
        if ((s.pop(), s.length)) {
          let l = s.join("/");
          window.app.vault.getAbstractFileByPath(l) ||
            (await window.app.vault.createFolder(l));
        }
        return await app.fileManager.renameFile(n, o), "";
      };
    }
    generate_path() {
      return (e = !1) => {
        let t = "";
        if (ie.Platform.isMobileApp) {
          let n = app.vault.adapter.fs.uri,
            o = app.vault.adapter.basePath;
          t = `${n}/${o}`;
        } else if (app.vault.adapter instanceof ie.FileSystemAdapter)
          t = app.vault.adapter.getBasePath();
        else throw new w("app.vault is not a FileSystemAdapter instance");
        return e
    ...
    generate_rename() {
      return async (e) => {
        ...
        let t = (0, ie.normalizePath)(
          `${this.config.target_file.parent.path}/${e}.${this.config.target_file.extension}`,
        );
        return await app.fileManager.renameFile(this.config.target_file, t), "";
      };
    }
    generate_selection() {
      return () => {
        let e = app.workspace.activeEditor;
        if (!e || !e.editor)
    ...
    generate_tags() {
      let e = app.metadataCache.getFileCache(this.config.target_file);
      return e ? (0, ie.getAllTags)(e) : null;
    }
    generate_title() {
...
var Lr = class extends pe {
  ...
  async getRequest(e) {
    try {
      let t = await fetch(e);
      if (!t.ok) throw new w("Error performing GET request");
      return t;
    } catch {
  ...
  generate_daily_quote() {
    return async () => {
      try {
        let t = await (
            await this.getRequest("https://api.quotable.io/random")
          ).json(),
          n = t.author;
...
> \u2014 ${n}`;
        ...
        return (
          new w("Error generating daily quote"), "Error generating daily quote"
        );
      }
    };
  }
  generate_random_picture() {
    return async (e, t, n = !1) => {
      try {
        ...
        return n
          ? `![photo by ${o.photog}(${o.photogUrl}) on Unsplash|${e}](${s})`
          : `![photo by ${o.photog}(${o.photogUrl}) on Unsplash](${s})`;
      } catch {
        return (
          new w("Error generating random picture"),
  ...
  generate_request() {
    return async (e, t) => {
      try {
        ...
        return t && o
          ? t.split(".").reduce((s, l) => {
              if (s && s.hasOwnProperty(l)) return s[l];
              throw new Error(`Path ${t} not found in the JSON response`);
            }, o)
          : o;
      } catch (n) {
        throw (console.error(n), new w("Error fetching and extracting value"));
      }
    };
  }
};
var Hr = class extends pe {
  ...
  generate_on_all_templates_executed() {
    return (e) => {
      let t = app.workspace.on("templater:all-templates-executed", async () => {
        await pr(1), e();
      });
...
var Ce = V(require("obsidian"));
var Vr = class extends Ce.Modal {
  constructor(e, t, n) {
    super(app);
    this.prompt_text = e;
...
var ai = V(require("obsidian")),
  Wr = class extends ai.FuzzySuggestModal {
    constructor(e, t, n, o) {
      super(app);
      this.text_items = e;
      this.items = t;
      this.submitted = !1;
      this.setPlaceholder(n), o && (this.limit = o);
    }
    getItems() {
      return this.items;
    }
...
var Kr = class extends pe {
  ...
  generate_prompt() {
    return async (e, t, n = !1, o = !1) => {
      let s = new Vr(e, t, o),
        l = new Promise((p, A) => s.openAndGetValue(p, A));
      try {
        return await l;
      } catch (p) {
        if (n) throw p;
  ...
  generate_suggester() {
    return async (e, t, n = !1, o = "", s) => {
      let l = new Wr(e, t, o, s),
        p = new Promise((A, g) => l.openAndGetValue(A, g));
      try {
        return await p;
      } catch (A) {
        if (n) throw A;
...
var zr = class {
  constructor(e) {
    this.plugin = e;
    this.modules_array = [];
    this.modules_array.push(new Rr(this.plugin)),
      this.modules_array.push(new Yr(this.plugin)),
      this.modules_array.push(new Lr(this.plugin)),
      this.modules_array.push(new Gr(this.plugin)),
      this.modules_array.push(new Hr(this.plugin)),
      this.modules_array.push(new Kr(this.plugin)),
      this.modules_array.push(new Ur(this.plugin));
  }
  async init() {
...
var li = V(require("child_process")),
  ci = V(require("util")),
  Gt = V(require("obsidian"));
var Jr = class {
  constructor(e) {
    this.plugin = e;
    Gt.Platform.isMobileApp ||
    !(app.vault.adapter instanceof Gt.FileSystemAdapter)
      ? (this.cwd = "")
      : ((this.cwd = app.vault.adapter.getBasePath()),
        (this.exec_promise = (0, ci.promisify)(li.exec)));
  }
  async generate_system_functions(e) {
    ...
    for (let o of this.plugin.settings.templates_pairs) {
      ...
      !s ||
        !l ||
        (Gt.Platform.isMobileApp
          ? t.set(s, () => new Promise((p) => p(ii)))
          : ((l = await this.plugin.templater.parser.parse_commands(l, n)),
            t.set(s, async (p) => {
              let A = { ...process.env, ...p },
                g = {
              ...
              try {
                let { stdout: f } = await this.exec_promise(l, g);
                return f.trimRight();
              } catch (f) {
...
var Xr = class {
  ...
  async load_user_script_function(e, t) {
    let n = (A) => window.require && window.require(A),
      o = {},
      s = { exports: o },
      l = await app.vault.read(e);
    try {
      window.eval(
      ...
      throw new w(`Failed to load user script at "${e.path}".`, A.message);
    }
    let p = o.default || s.exports;
    if (!p)
      throw new w(
...
var Qr = class {
  constructor(e) {
    this.plugin = e;
    (this.user_system_functions = new Jr(e)),
      (this.user_script_functions = new Xr(e));
  }
  async generate_object(e) {
    let t = {},
      n = {};
...
var Zr = class {
  constructor(e) {
    this.plugin = e;
    (this.internal_functions = new zr(this.plugin)),
      (this.user_functions = new Qr(this.plugin));
  }
  async init() {
  ...
  async generate_object(e, t = 1) {
    let n = {},
      o = this.additional_functions(),
      s = await this.internal_functions.generate_object(e),
      l = {};
    switch ((Object.assign(n, o), t)) {
      case 0:
        Object.assign(n, s);
        break;
      case 1:
        (l = await this.user_functions.generate_object(e)),
          Object.assign(n, { ...s, user: l });
        break;
    }
    return n;
  }
...
var Ai = new TextDecoder("utf-8", { ignoreBOM: !0, fatal: !0 });
Ai.decode();
var ur = new Uint8Array();
function mr() {
  return ur.byteLength === 0 && (ur = new Uint8Array(v.memory.buffer)), ur;
}
function tt(r, e) {
  return Ai.decode(mr().subarray(r, r + e));
}
function rt(r) {
  Vt === ke.length && ke.push(ke.length + 1);
  let e = Vt;
  return (Vt = ke[e]), (ke[e] = r), e;
}
var Te = 0,
  fr = new TextEncoder("utf-8"),
  Bo =
    typeof fr.encodeInto == "function"
      ? function (r, e) {
          return fr.encodeInto(r, e);
        }
      : function (r, e) {
          let t = fr.encode(r);
...
function ze(r, e, t) {
  ...
  let n = r.length,
    ...
    l = 0;
  for (; l < n; l++) {
    let p = r.charCodeAt(l);
    if (p > 127) break;
    s[o + l] = p;
  }
  if (l !== n) {
    l !== 0 && (r = r.slice(l)), (o = t(o, n, (n = l + r.length * 3)));
    let p = mr().subarray(o + l, o + n);
    l += Bo(r, p).written;
  }
  return (Te = l), o;
}
...
var dr = new Int32Array();
function ge() {
  return dr.byteLength === 0 && (dr = new Int32Array(v.memory.buffer)), dr;
}
function tn(r) {
  let e = typeof r;
...
var gr = 32;
function Io(r) {
  if (gr == 1) throw new Error("out of js stack");
  return (ke[--gr] = r), gr;
}
function rn(r, e) {
  try {
    ...
    v.__wbindgen_exn_store(rt(t));
  }
}
var dt = class {
    static __wrap(e) {
      let t = Object.create(dt.prototype);
      return (t.ptr = e), t;
    }
    __destroy_into_raw() {
      let e = this.ptr;
    ...
    constructor(e, t, n, o, s, l, p) {
      let A = ze(e, v.__wbindgen_malloc, v.__wbindgen_realloc),
        g = Te,
        f = ze(t, v.__wbindgen_malloc, v.__wbindgen_realloc),
        b = Te,
        k = ze(p, v.__wbindgen_malloc, v.__wbindgen_realloc),
        x = Te,
        O = v.parserconfig_new(
          A,
          g,
          f,
          b,
    ...
    get opening_tag() {
      try {
        ...
        v.__wbindgen_add_to_stack_pointer(16), v.__wbindgen_free(e, t);
      }
    }
    set opening_tag(e) {
      let t = ze(e, v.__wbindgen_malloc, v.__wbindgen_realloc),
        n = Te;
  ...
  Ft = class {
    ...
    render_content(e, t) {
      try {
        let l = v.__wbindgen_add_to_stack_pointer(-16),
          p = ze(e, v.__wbindgen_malloc, v.__wbindgen_realloc),
          A = Te;
        v.renderer_render_content(l, this.ptr, p, A, Io(t));
        var n = ge()[l / 4 + 0],
          o = ge()[l / 4 + 1],
          s = ge()[l / 4 + 2];
        if (s) throw en(o);
        ...
        v.__wbindgen_add_to_stack_pointer(16), (ke[gr++] = void 0);
      }
    }
  };
...
function Co() {
  ...
  return (
    ...
    (r.wbg.__wbindgen_string_get = function (e, t) {
      ...
      var s = Oo(o) ? 0 : ze(o, v.__wbindgen_malloc, v.__wbindgen_realloc),
        l = Te;
      (ge()[e / 4 + 1] = l), (ge()[e / 4 + 0] = s);
    }),
    ...
    (r.wbg.__wbindgen_debug_string = function (e, t) {
      let n = tn(de(t)),
        o = ze(n, v.__wbindgen_malloc, v.__wbindgen_realloc),
        s = Te;
...
async function pi(r) {
  typeof r == "undefined" && (r = new URL("rusty_engine_bg.wasm", No.url));
  let e = Co();
  (typeof r == "string" ||
    ...
    (r = fetch(r)),
    Do(e);
  let { instance: t, module: n } = await So(await r, e);
  return $o(t, n);
}
var ui = pi;
var mi = kn(
...
var $e;
(function (l) {
  (l[(l.CreateNewFromTemplate = 0)] = "CreateNewFromTemplate"),
    (l[(l.AppendActiveFile = 1)] = "AppendActiveFile"),
    (l[(l.OverwriteFile = 2)] = "OverwriteFile"),
    (l[(l.OverwriteActiveFile = 3)] = "OverwriteActiveFile"),
    (l[(l.DynamicProcessor = 4)] = "DynamicProcessor"),
    (l[(l.StartupTemplate = 5)] = "StartupTemplate");
})($e || ($e = {}));
var Wt = class {
  constructor(e) {
    this.plugin = e;
    (this.functions_generator = new Zr(this.plugin)), (this.parser = new nn());
  }
  async setup() {
  ...
  async read_and_parse_template(e) {
    let t = await app.vault.read(e.template_file);
  ...
  async create_new_note_from_template(e, t, n, o = !0) {
    if (!t)
      switch (app.vault.getConfig("newFileLocation")) {
        ...
        case "folder":
          t = app.fileManager.getNewFileParent("");
          break;
        case "root":
          t = app.vault.getRoot();
          break;
    ...
    let s = (e instanceof ve.TFile && e.extension) || "md",
      l = await Oe(async () => {
        ...
        return (
          k &&
            !app.vault.getAbstractFileByPathInsensitive(k) &&
            (await app.vault.createFolder(k)),
          app.vault.create(b, "")
        );
      }, `Couldn't create ${s} file.`);
    if (l == null) return;
    let { path: p } = l;
    this.start_templater_task(p);
    let A, g;
    if (
      (e instanceof ve.TFile
        ? ((A = this.create_running_config(e, l, 0)),
          (g = await Oe(
            async () => this.read_and_parse_template(A),
            "Template parsing error, aborting.",
          )))
        : ((A = this.create_running_config(void 0, l, 0)),
          (g = await Oe(
            async () => this.parse_template(A, e),
            "Template parsing error, aborting.",
          ))),
      g == null)
    ) {
      await app.vault.delete(l), await this.end_templater_task(p);
      return;
    }
    if (
      (await app.vault.modify(l, g),
      ...
      let f = app.workspace.getLeaf(!1);
      if (!f) {
        K(new w("No active leaf"));
        return;
      }
      await f.openFile(l, { state: { mode: "source" } }),
        await this.plugin.editor_handler.jump_to_next_cursor_location(l, !0),
        f.setEphemeralState({ rename: "all" });
    }
    return await this.end_templater_task(p), l;
  }
  async append_template_to_active_file(e) {
    let t = app.workspace.getActiveViewOfType(ve.MarkdownView),
      n = app.workspace.activeEditor;
    ...
    let A = n.editor.getDoc(),
      g = A.listSelections();
    A.replaceSelection(l),
      n.file && (await app.vault.append(n.file, "")),
      app.workspace.trigger("templater:template-appended", {
        view: t,
        editor: n,
        content: l,
        oldSelections: g,
        newSelections: A.listSelections(),
      }),
  ...
  async write_template_to_file(e, t) {
    ...
    let o = app.workspace.activeEditor,
      s = kt(app),
  ...
  async process_dynamic_templates(e, t) {
    ...
    for (; (s = o.nextNode()); ) {
      ...
      if (A !== null) {
        let g = n.exec(A);
        if (g !== null) {
          let f = app.metadataCache.getFirstLinkpathDest("", t.sourcePath);
          if (!f || !(f instanceof ve.TFile)) return;
          if (!l) {
            l = !0;
            let b = this.create_running_config(f, f, 4);
            (p = await this.functions_generator.generate_object(
              b,
              De.USER_INTERNAL,
            )),
              (this.current_functions_object = p);
          }
        }
        for (; g != null; ) {
          let f = g[1] + g[2],
            b = await Oe(
              async () => await this.parser.parse_commands(f, p),
              `Command Parsing error in dynamic command '${f}'`,
            );
          if (b == null) return;
          let k = n.lastIndex - g[0].length,
            x = n.lastIndex;
          (A = A.substring(0, k) + b + A.substring(x)),
            (n.lastIndex += b.length - g[0].length),
            (g = n.exec(A));
        }
        s.nodeValue = A;
      }
  ...
  static async on_file_creation(e, t) {
    if (!(t instanceof ve.TFile) || t.extension !== "md") return;
    let n = (0, ve.normalizePath)(e.plugin.settings.templates_folder);
    if (
      !(t.path.includes(n) && n !== "/") &&
      (await pr(300), !e.files_with_pending_templates.has(t.path))
    )
      if (t.stat.size == 0 && e.plugin.settings.enable_folder_templates) {
        let o = e.get_new_file_template_for_folder(t.parent);
        if (!o) return;
        let s = await Oe(async () => Yt(o), `Couldn't find template ${o}`);
        if (s == null) return;
        await e.write_template_to_file(s, t);
      } else
        t.stat.size <= 1e5
          ? await e.overwrite_file_commands(t)
          : console.log(
              `Templater skipped parsing ${t.path} because file size exceeds 10000`,
            );
  }
  async execute_startup_scripts() {
    for (let e of this.plugin.settings.startup_templates) {
      if (!e) continue;
      let t = me(() => Yt(e), `Couldn't find startup template "${e}"`);
      if (!t) continue;
      let { path: n } = t;
      this.start_templater_task(n);
    ...
    update_trigger_file_on_creation() {
      this.settings.trigger_on_file_creation
        ? ((this.trigger_on_file_creation_event = this.plugin.app.vault.on(
            "create",
            (e) => Wt.on_file_creation(this.templater, e),
          )),
      ...
      t &&
        this.plugin.addCommand({
          ...
          callback: () => {
            ...
            !n || this.plugin.templater.append_template_to_active_file(n);
          },
        });
  }
  remove_template_hotkey(e) {
    e && app.commands.removeCommand(`${this.plugin.manifest.id}:${e}`);
  }
};
var An = V(require("obsidian"));
var sn = V(require("obsidian"));
var an = class {
  constructor() {}
  async jump_to_next_cursor_location() {
    ...
    if (o) {
      let s = e instanceof sn.MarkdownView ? e.currentMode.getFoldInfo() : null;
      e.editor.setValue(n),
        s &&
          Array.isArray(s.folds) &&
          (o.forEach((l) => {
            s.folds = s.folds.filter((p) => p.from > l.line || p.to < l.line);
          }),
          e instanceof sn.MarkdownView && e.currentMode.applyFoldInfo(s)),
...
`,
  ...
  replace_and_get_cursor_positions(e) {
    ...
    t.sort(
      (A, g) =>
        Number(A.groups && A.groups.order) - Number(g.groups && g.groups.order),
    );
    let s = t[0][0];
    t = t.filter((A) => A[0] === s);
    let l = [],
    ...
    for (let A of t) {
      let g = A.index - p;
      if (
        (l.push(this.get_editor_position_from_index(e, g)),
        (e = e.replace(new RegExp(Qn(A[0])), "")),
        (p += A[0].length),
        A[1] === "")
      )
        break;
    }
    return { new_content: e, positions: l };
  }
  set_cursor_location(e) {
    ...
    let n = t.editor,
      o = [];
    for (let l of e) o.push({ from: l });
    let s = { selections: o };
    n.transaction(s);
  }
};
var _i = V(require("obsidian"));
var Yo = {
    config: {
      name: "config",
...
var Lo = [
  ...
  Ho = new Set(Lo);
function hi(r) {
  return typeof r == "string" && Ho.has(r);
}
function ji(r) {
  return !!r.definition;
}
var ln = class {
  ...
  get_all_functions_documentation(e) {
    ...
    if (!!this.documentation.tp[e].functions)
      return Object.values(this.documentation.tp[e].functions);
  }
...
var cn = class extends _i.EditorSuggest {
  constructor(e) {
    super(app);
    this.tp_keyword_regex =
      /tp\.(?<module>[a-z]*)?(?<fn_trigger>\.(?<fn>[a-z_]*)?)?$/;
    this.documentation = new ln(e);
  }
  onTrigger(e, t, n) {
    ...
    if (!s) return null;
    let l,
      p = (s.groups && s.groups.module) || "";
    if (((this.module_name = p), s.groups && s.groups.fn_trigger)) {
      if (p == "" || !hi(p)) return null;
      (this.function_trigger = !0),
        (this.function_name = s.groups.fn || ""),
        (l = this.function_name);
    } else (this.function_trigger = !1), (l = this.module_name);
    let A = {
      start: { line: e.line, ch: e.ch - l.length },
      end: { line: e.line, ch: e.ch },
      query: l,
    };
    return (this.latest_trigger_info = A), A;
  }
  getSuggestions(e) {
    let t;
    return (
      this.module_name && this.function_trigger
        ? (t = this.documentation.get_all_functions_documentation(
            this.module_name,
          ))
        : (t = this.documentation.get_all_modules_documentation()),
      t ? t.filter((n) => n.name.startsWith(e.query)) : []
    );
  }
  renderSuggestion(e, t) {
    t.createEl("b", { text: e.name }),
      t.createEl("br"),
  ...
  selectSuggestion(e, t) {
    let n = app.workspace.activeEditor;
    if (
      !(!n || !n.editor) &&
      ...
      (o.ch += e.name.length), n.editor.setCursor(o);
    }
  }
};
(function (r) {
  ...
  r.defineMode("javascript", function (e, t) {
    ...
    function x(i) {
      for (var a = !1, u, d = !1; (u = i.next()) != null; ) {
        if (!a) {
          if (u == "/" && !d) return;
          u == "[" ? (d = !0) : d && u == "]" && (d = !1);
        }
    ...
    function P(i, a) {
      var u = i.next();
      if (u == '"' || u == "'") return (a.tokenize = L(u)), a.tokenize(i, a);
      ...
      if (u == "/")
        return i.eat("*")
          ? ((a.tokenize = N), N(i, a))
          : i.eat("/")
            ? (i.skipToEnd(), j("comment", "comment"))
            : xn(i, a, 1)
              ? (x(i),
                i.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/),
                j("regexp", "string-2"))
              : (i.eat("="), j("operator", "operator", i.current()));
      if (u == "`") return (a.tokenize = T), T(i, a);
      if (u == "#" && i.peek() == "!") return i.skipToEnd(), j("meta", "meta");
      if (u == "#" && i.eatWhile(g)) return j("variable", "property");
      if (
        (u == "<" && i.match("!--")) ||
        (u == "-" && i.match("->") && !/\S/.test(i.string.slice(0, i.start)))
      )
        return i.skipToEnd(), j("comment", "comment");
      if (b.test(u))
        return (
          (u != ">" || !a.lexical || a.lexical.type != ">") &&
            (i.eat("=")
              ? (u == "!" || u == "=") && i.eat("=")
              : /[<>*+\-|&?]/.test(u) && (i.eat(u), u == ">" && i.eat(u))),
          u == "?" && i.eat(".")
            ? j(".")
            : j("operator", "operator", i.current())
        );
      if (g.test(u)) {
        i.eatWhile(g);
        var d = i.current();
        if (a.lastType != ".") {
          if (f.propertyIsEnumerable(d)) {
            var E = f[d];
            return j(E.type, E.style, d);
          }
          if (
            d == "async" &&
            i.match(/^(\s|\/\*([^*]|\*(?!\/))*?\*\/)*[\[\(\w]/, !1)
          )
            return j("async", "keyword", d);
        }
        return j("variable", "variable", d);
      }
    }
    function L(i) {
      return function (a, u) {
        var d = !1,
          E;
        if (s && a.peek() == "@" && a.match(k))
          return (u.tokenize = P), j("jsonld-keyword", "meta");
        for (; (E = a.next()) != null && !(E == i && !d); ) d = !d && E == "\\";
        return d || (u.tokenize = P), j("string", "string");
      };
    }
    function N(i, a) {
      for (var u = !1, d; (d = i.next()); ) {
        if (d == "/" && u) {
          a.tokenize = P;
          break;
        }
    ...
    function T(i, a) {
      ...
      return j("quasi", "string-2", i.current());
    }
    var S = "([{}])";
    function q(i, a) {
      a.fatArrowAt && (a.fatArrowAt = null);
      var u = i.string.indexOf("=>", i.start);
      if (!(u < 0)) {
        if (A) {
          var d = /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(
            i.string.slice(i.start, u),
          );
          d && (u = d.index);
        }
        for (var E = 0, B = !1, $ = u - 1; $ >= 0; --$) {
          var ce = i.string.charAt($),
            Be = S.indexOf(ce);
          if (Be >= 0 && Be < 3) {
            if (!E) {
              ++$;
          ...
          else if (g.test(ce)) B = !0;
          else if (/["'\/`]/.test(ce))
            for (; ; --$) {
              if ($ == 0) return;
              var Ni = i.string.charAt($ - 1);
              if (Ni == ce && i.string.charAt($ - 2) != "\\") {
                $--;
                break;
              }
            }
    ...
    function J(i, a) {
      if (!p) return !1;
      for (var u = i.localVars; u; u = u.next) if (u.name == a) return !0;
      for (var d = i.context; d; d = d.prev)
        for (var u = d.vars; u; u = u.next) if (u.name == a) return !0;
    }
    function G(i, a, u, d, E) {
      var B = i.cc;
      for (
        m.state = i,
          m.stream = E,
        ...
        var $ = B.length ? B.pop() : l ? C : H;
        if ($(u, d)) {
          for (; B.length && B[B.length - 1].lex; ) B.pop()();
          return m.marked
            ? m.marked
            : u == "variable" && J(i, d)
              ? "variable-2"
    ...
    function h() {
      for (var i = arguments.length - 1; i >= 0; i--) m.cc.push(arguments[i]);
    }
    function c() {
      return h.apply(null, arguments), !0;
    }
    function we(i, a) {
      for (var u = a; u; u = u.next) if (u.name == i) return !0;
      return !1;
    }
    function ue(i) {
      var a = m.state;
      if (((m.marked = "def"), !!p)) {
        if (a.context) {
          if (a.lexical.info == "var" && a.context && a.context.block) {
            var u = oe(i, a.context);
            if (u != null) {
              a.context = u;
              return;
            }
          } else if (!we(i, a.localVars)) {
            a.localVars = new fe(i, a.localVars);
            return;
          }
        }
        t.globalVars &&
          !we(i, a.globalVars) &&
          (a.globalVars = new fe(i, a.globalVars));
      }
    }
    function oe(i, a) {
      if (a)
        if (a.block) {
          var u = oe(i, a.prev);
          return u ? (u == a.prev ? a : new Fe(u, a.vars, !0)) : null;
        } else return we(i, a.vars) ? a : new Fe(a.prev, new fe(i, a.vars), !1);
      else return null;
    }
    function se(i) {
      return (
    ...
    function Fe(i, a, u) {
      (this.prev = i), (this.vars = a), (this.block = u);
    }
    function fe(i, a) {
      (this.name = i), (this.next = a);
    }
    var gt = new fe("this", new fe("arguments", null));
    function Me() {
      (m.state.context = new Fe(m.state.context, m.state.localVars, !1)),
        (m.state.localVars = gt);
    }
    function Ne() {
      (m.state.context = new Fe(m.state.context, m.state.localVars, !0)),
    ...
    function y(i, a) {
      var u = function () {
        var d = m.state,
          E = d.indented;
        if (d.lexical.type == "stat") E = d.lexical.indented;
        else
          for (var B = d.lexical; B && B.type == ")" && B.align; B = B.prev)
            E = B.indented;
        d.lexical = new z(E, m.stream.column(), i, null, d.lexical, a);
      };
      return (u.lex = !0), u;
    }
    function _() {
      var i = m.state;
      i.lexical.prev &&
        (i.lexical.type == ")" && (i.indented = i.lexical.indented),
        (i.lexical = i.lexical.prev));
    }
    _.lex = !0;
    function F(i) {
      function a(u) {
                  ...
                  : i == ";"
                    ...
                    : i == "if"
                      ? (m.state.lexical.info == "else" &&
                          m.state.cc[m.state.cc.length - 1] == _ &&
                          m.state.cc.pop()(),
                        c(y("form"), nt, H, _, hn))
                      : i == "function"
                        ? c(Qe)
                        : i == "for"
                          ? c(y("form"), Ne, jn, H, ae, _)
                          : i == "class" || (A && a == "interface")
                            ? ((m.marked = "keyword"),
                              c(y("form", i == "class" ? i : a), vn, _))
                            : i == "variable"
                              ? A && a == "declare"
                                ? ((m.marked = "keyword"), c(H))
                                : A &&
                                    (a == "module" ||
                                      a == "enum" ||
                                      a == "type") &&
    ...
    function nt(i) {
      return i != "(" ? h() : c(y(")"), Ye, F(")"), _);
    }
    function Kt(i, a, u) {
      if (m.state.fatArrowAt == m.stream.start) {
        var d = u ? Jt : zt;
        if (i == "(") return c(Me, y(")"), X(st, ")"), _, F("=>"), d, ae);
        if (i == "variable") return h(Me, be, F("=>"), d, ae);
      }
      var E = u ? Je : Le;
      return R.hasOwnProperty(i)
        ...
        : i == "function"
          ? c(Qe, E)
          : i == "class" || (A && a == "interface")
            ? ((m.marked = "keyword"), c(y("form"), Oi, _))
            : i == "keyword c" || i == "async"
              ? c(u ? le : C)
              : i == "("
                ? c(y(")"), Ye, F(")"), _, E)
    ...
    function Ye(i) {
      return i.match(/[;\}\)\],]/) ? h() : h(C);
    }
    function Le(i, a) {
      return i == "," ? c(Ye) : Je(i, a, !1);
    }
    function Je(i, a, u) {
      var d = u == !1 ? Le : Je,
        E = u == !1 ? C : le;
      if (i == "=>") return c(Me, u ? Jt : zt, ae);
      if (i == "operator")
        return /\+\+|--/.test(a) || (A && a == "!")
          ? c(d)
          : A && a == "<" && m.stream.match(/^([^<>]|<[^<>]*>)*>\s*\(/, !1)
            ? c(y(">"), X(D, ">"), _, d)
            : a == "?"
              ? c(C, F(":"), E)
              : c(E);
      if (i == "quasi") return h(it, d);
      if (i != ";") {
        if (i == "(") return Pt(le, ")", "call", d);
        if (i == ".") return c(Mt, d);
        if (i == "[") return c(y("]"), Ye, F("]"), _, d);
        if (A && a == "as") return (m.marked = "keyword"), c(D, d);
        if (i == "regexp")
          return (
    ...
    function Ut(i) {
      if (i == "}")
        return (m.marked = "string-2"), (m.state.tokenize = T), c(it);
    }
    function zt(i) {
      return q(m.stream, m.state), h(i == "{" ? H : C);
    }
    function Jt(i) {
      return q(m.stream, m.state), h(i == "{" ? H : le);
    }
    function He(i) {
      return function (a) {
        return a == "."
    ...
    function ht(i, a) {
      if (a == "target") return (m.marked = "keyword"), c(Le);
    }
    function Xt(i, a) {
      if (a == "target") return (m.marked = "keyword"), c(Je);
    }
    function Qt(i) {
      return i == ":" ? c(_, H) : h(Le, F(";"), _);
    }
    function Mt(i) {
      if (i == "variable") return (m.marked = "property"), c();
    }
    function ot(i, a) {
      if (i == "async") return (m.marked = "property"), c(ot);
      if (i == "variable" || m.style == "keyword") {
        if (((m.marked = "property"), a == "get" || a == "set")) return c(Zt);
        var u;
        return (
          A &&
            m.state.fatArrowAt == m.stream.start &&
            (u = m.stream.match(/^\s*:\s*/, !1)) &&
            (m.state.fatArrowAt = m.stream.pos + u[0].length),
          c(Pe)
        );
      } else {
        if (i == "number" || i == "string")
          return (m.marked = s ? "property" : m.style + " property"), c(Pe);
        if (i == "jsonld-keyword") return c(Pe);
        if (A && se(a)) return (m.marked = "keyword"), c(ot);
        if (i == "[") return c(C, jt, F("]"), Pe);
        if (i == "spread") return c(le, Pe);
        if (a == "*") return (m.marked = "keyword"), c(ot);
        if (i == ":") return h(Pe);
      }
    }
    function Zt(i) {
      return i != "variable" ? h(Pe) : ((m.marked = "property"), c(Qe));
    }
    function Pe(i) {
      if (i == ":") return c(le);
      if (i == "(") return h(Qe);
    ...
    function X(i, a, u) {
      function d(E, B) {
        if (u ? u.indexOf(E) > -1 : E == ",") {
          var $ = m.state.lexical;
          return (
            $.info == "call" && ($.pos = ($.pos || 0) + 1),
            c(function (ce, Be) {
              return ce == a || Be == a ? h() : h(i);
            }, d)
          );
        }
        return E == a || B == a
      ...
      return function (E, B) {
        return E == a || B == a ? c() : h(i, d);
      };
    }
    function Pt(i, a, u) {
      for (var d = 3; d < arguments.length; d++) m.cc.push(arguments[d]);
      return c(y(a, u), X(i, a), _);
    }
    function er(i) {
      return i == "}" ? c() : h(H, er);
    }
    ...
    function yi(i, a) {
      if (A && (i == ":" || a == "in")) return c(D);
    }
    function dn(i) {
      if (A && i == ":")
        return m.stream.match(/^\s*\w+\s+is\b/, !1) ? c(C, xi, D) : c(D);
    }
    function xi(i, a) {
      if (a == "is") return (m.marked = "keyword"), c();
    }
    function D(i, a) {
      if (a == "keyof" || a == "typeof" || a == "infer" || a == "readonly")
        return (m.marked = "keyword"), c(a == "typeof" ? le : D);
      if (i == "variable" || a == "void") return (m.marked = "type"), c(Ge);
      if (a == "|" || a == "&") return c(D);
      if (i == "string" || i == "number" || i == "atom") return c(Ge);
      if (i == "[") return c(y("]"), X(D, "]", ","), _, Ge);
      if (i == "{") return c(y("}"), _r, _, Ge);
      if (i == "(") return c(X(wr, ")"), Ei, Ge);
      if (i == "<") return c(X(D, ">"), D);
      if (i == "quasi") return h(vr, Ge);
    }
    function Ei(i) {
      if (i == "=>") return c(D);
    }
    ...
    function Bt(i, a) {
      if (i == "variable" || m.style == "keyword")
        return (m.marked = "property"), c(Bt);
      if (a == "?" || i == "number" || i == "string") return c(Bt);
      if (i == ":") return c(D);
      if (i == "[") return c(F("variable"), yi, F("]"), Bt);
      if (i == "(") return h(vt, Bt);
      if (!i.match(/[;\}\)\],]/)) return c();
    }
    function vr(i, a) {
    ...
    function ki(i) {
      if (i == "}")
        return (m.marked = "string-2"), (m.state.tokenize = T), c(vr);
    }
    function wr(i, a) {
      return (i == "variable" && m.stream.match(/^\s*[?:]/, !1)) || a == "?"
        ? c(wr)
        : i == ":"
          ? c(D)
          : i == "spread"
    ...
    function Ge(i, a) {
      if (a == "<") return c(y(">"), X(D, ">"), _, Ge);
      if (a == "|" || i == "." || a == "&") return c(D);
      if (i == "[") return c(D, F("]"), Ge);
      if (a == "extends" || a == "implements")
        return (m.marked = "keyword"), c(D);
      if (a == "?") return c(D, F(":"), D);
    }
    function Ti(i, a) {
      if (a == "<") return c(y(">"), X(D, ">"), _, Ge);
    ...
    function br(i, a) {
      return a == "enum" ? ((m.marked = "keyword"), c(yn)) : h(be, jt, Xe, Pi);
    }
    function be(i, a) {
      if (A && se(a)) return (m.marked = "keyword"), c(be);
      if (i == "variable") return ue(a), c();
      if (i == "spread") return c(be);
      if (i == "[") return Pt(Mi, "]");
      if (i == "{") return Pt(gn, "}");
    }
    function gn(i, a) {
      return i == "variable" && !m.stream.match(/^\s*:/, !1)
        ? (ue(a), c(Xe))
        : (i == "variable" && (m.marked = "property"),
          i == "spread"
            ? c(be)
            : i == "}"
              ? h()
    ...
    function hn(i, a) {
      if (i == "keyword b" && a == "else") return c(y("form", "else"), H, _);
    }
    function jn(i, a) {
      if (a == "await") return c(jn);
      if (i == "(") return c(y(")"), Bi, _);
    }
    function Bi(i) {
      return i == "var" ? c(br, _t) : i == "variable" ? c(_t) : h(_t);
    }
    function _t(i, a) {
      return i == ")"
        ? c()
        : i == ";"
          ? c(_t)
          : a == "in" || a == "of"
            ? ((m.marked = "keyword"), c(C, _t))
            : h(C, _t);
    }
    function Qe(i, a) {
      if (a == "*") return (m.marked = "keyword"), c(Qe);
      if (i == "variable") return ue(a), c(Qe);
      if (i == "(") return c(Me, y(")"), X(st, ")"), _, dn, H, ae);
      if (A && a == "<") return c(y(">"), X(tr, ">"), _, Qe);
    }
    function vt(i, a) {
      if (a == "*") return (m.marked = "keyword"), c(vt);
      if (i == "variable") return ue(a), c(vt);
      if (i == "(") return c(Me, y(")"), X(st, ")"), _, dn, ae);
      if (A && a == "<") return c(y(">"), X(tr, ">"), _, vt);
    }
    function _n(i, a) {
      if (i == "keyword" || i == "variable") return (m.marked = "type"), c(_n);
      if (a == "<") return c(y(">"), X(tr, ">"), _);
    }
    function st(i, a) {
      return (
        a == "@" && c(C, st),
    ...
    function Oi(i, a) {
      return i == "variable" ? vn(i, a) : rr(i, a);
    }
    function vn(i, a) {
      if (i == "variable") return ue(a), c(rr);
    }
    function rr(i, a) {
      if (a == "<") return c(y(">"), X(tr, ">"), _, rr);
      if (a == "extends" || a == "implements" || (A && i == ","))
        return a == "implements" && (m.marked = "keyword"), c(A ? D : C, rr);
      if (i == "{") return c(y("}"), Ve, _);
    }
    function Ve(i, a) {
      if (
        i == "async" ||
        (i == "variable" &&
          (a == "static" || a == "get" || a == "set" || (A && se(a))) &&
          m.stream.match(/^\s+[\w$\xa1-\uffff]/, !1))
      )
        return (m.marked = "keyword"), c(Ve);
      if (i == "variable" || m.style == "keyword")
        return (m.marked = "property"), c(Ot, Ve);
      if (i == "number" || i == "string") return c(Ot, Ve);
      if (i == "[") return c(C, jt, F("]"), Ot, Ve);
      if (a == "*") return (m.marked = "keyword"), c(Ve);
      if (A && i == "(") return h(vt, Ve);
      if (i == ";" || i == ",") return c(Ve);
      if (i == "}") return c();
      if (a == "@") return c(C, Ve);
    }
    function Ot(i, a) {
      ...
      if (i == ":") return c(D, Xe);
      if (a == "=") return c(le);
      var u = m.state.lexical.prev,
        d = u && u.info == "interface";
      return h(d ? vt : Qe);
    }
    function qi(i, a) {
      return a == "*"
        ? ((m.marked = "keyword"), c(yr, F(";")))
        : a == "default"
          ? ((m.marked = "keyword"), c(C, F(";")))
          : i == "{"
            ? c(X(wn, "}"), yr, F(";"))
            : h(H);
    }
    function wn(i, a) {
      if (a == "as") return (m.marked = "keyword"), c(F("variable"));
      if (i == "variable") return h(le, wn);
    }
    function Ii(i) {
      return i == "string"
        ? c()
    ...
    function nr(i, a) {
      return i == "{"
        ? Pt(nr, "}")
        : (i == "variable" && ue(a), a == "*" && (m.marked = "keyword"), c(Si));
    }
    function bn(i) {
      if (i == ",") return c(nr, bn);
    }
    function Si(i, a) {
      if (a == "as") return (m.marked = "keyword"), c(nr);
    }
    function yr(i, a) {
      if (a == "from") return (m.marked = "keyword"), c(C);
    }
    function Ci(i) {
      return i == "]" ? c() : h(X(le, "]"));
    }
    function yn() {
      return h(y("form"), be, F("{"), y("}"), X(Di, "}"), _, _);
    }
    function Di() {
      return h(be, Xe);
    }
    ...
    function xn(i, a, u) {
      return (
        ...
        (a.lastType == "quasi" &&
          /\{\s*$/.test(i.string.slice(0, i.pos - (u || 0))))
      );
    }
    return {
      startState: function (i) {
        var a = {
          ...
          lastType: "sof",
          cc: [],
          lexical: new z((i || 0) - n, 0, "block", !1),
          localVars: t.localVars,
          context: t.localVars && new Fe(null, null, !1),
          indented: i || 0,
        };
        return (
          t.globalVars &&
      ...
      token: function (i, a) {
        if (
          (i.sol() &&
            (a.lexical.hasOwnProperty("align") || (a.lexical.align = !1),
            (a.indented = i.indentation()),
            q(i, a)),
          a.tokenize != N && i.eatSpace())
        )
          return null;
        var u = a.tokenize(i, a);
        return O == "comment"
          ? u
          : ((a.lastType =
              O == "operator" && (M == "++" || M == "--") ? "incdec" : O),
            G(a, u, O, M, i));
      },
      indent: function (i, a) {
        if (i.tokenize == N || i.tokenize == T) return r.Pass;
        if (i.tokenize != P) return 0;
        var u = a && a.charAt(0),
          d = i.lexical,
          E;
        if (!/^\s*else\b/.test(a))
          for (var B = i.cc.length - 1; B >= 0; --B) {
            var $ = i.cc[B];
            if ($ == _) d = d.prev;
            else if ($ != hn && $ != ae) break;
          }
        for (
          ...
          d = d.prev;
        o && d.type == ")" && d.prev.type == "stat" && (d = d.prev);
        var ce = d.type,
          Be = u == ce;
        return ce == "vardef"
          ? d.indented +
              (i.lastType == "operator" || i.lastType == ","
                ? d.info.length + 1
                : 0)
          : ce == "form" && u == "{"
            ? d.indented
            : ce == "form"
              ? d.indented + n
              : ce == "stat"
                ? d.indented + ($i(i, a) ? o || n : 0)
                : d.info == "switch" && !Be && t.doubleIndentSwitch != !1
                  ? d.indented + (/^(?:case|default)\b/.test(a) ? n : 2 * n)
                  : d.align
                    ? d.column + (Be ? 0 : 1)
                    : d.indented + (Be ? 0 : n);
      },
    ...
    return {
      ...
      blankLine: function (o) {
        ...
        return (
          ...
          t.blankLine && (l = t.blankLine(o.overlay)),
          l == null ? s : n && s != null ? s + " " + l : l
        );
      },
    };
  };
});
var vi = V(require("@codemirror/language")),
  wi = V(require("@codemirror/state")),
  bi = "templater",
  pn = "templater-command",
  un = "templater-inline",
  Go = "templater-opening-tag",
  Vo = "templater-closing-tag",
  Wo = "templater-interpolation-tag",
  Ko = "templater-execution-tag",
  mn = class {
    constructor(e) {
      this.plugin = e;
      (this.cursor_jumper = new an()), (this.activeEditorExtensions = []);
    }
    desktopShouldHighlight() {
      return (
        An.Platform.isDesktopApp && this.plugin.settings.syntax_highlighting
      );
    }
    mobileShouldHighlight() {
      return (
        An.Platform.isMobileApp &&
        this.plugin.settings.syntax_highlighting_mobile
      );
    }
    async setup() {
      this.plugin.registerEditorSuggest(new cn(this.plugin.settings)),
        await this.registerCodeMirrorMode(),
        (this.templaterLanguage = wi.Prec.high(
          vi.StreamLanguage.define(window.CodeMirror.getMode({}, bi)),
        )),
    ...
    async registerCodeMirrorMode() {
      ...
      window.CodeMirror.defineMode(bi, function (n) {
        let o = {
          startState: function () {
            return {
          ...
          token: function (s, l) {
            if ((s.sol() && l.inCommand && (l.freeLine = !0), l.inCommand)) {
              let A = "";
              if (s.match(/[-_]{0,1}%>/, !0)) {
                (l.inCommand = !1), (l.freeLine = !1);
                let f = l.tag_class;
                return (l.tag_class = ""), `line-${un} ${pn} ${Vo} ${f}`;
              }
              let g = e.token && e.token(s, l);
              return (
                s.peek() == null &&
                  l.freeLine &&
                  (A += " line-background-templater-command-bg"),
                l.freeLine || (A += ` line-${un}`),
                `${A} ${pn} ${g}`
              );
            }
            let p = s.match(/<%[-_]{0,1}\s*([*+]{0,1})/, !0);
            if (p != null) {
              switch (p[1]) {
                case "*":
                  l.tag_class = Ko;
              ...
              return (
                (l.inCommand = !0), `line-${un} ${pn} ${Go} ${l.tag_class}`
              );
            }
            for (; s.next() != null && !s.match(/<%/, !1); );
            return null;
          },
        };
        return t(window.CodeMirror.getMode(n, "hypermd"), o);
      });
    }
  };
var fn = class extends jr.Plugin {
  async onload() {
    await this.load_settings(),
      (this.templater = new Wt(this)),
      await this.templater.setup(),
      (this.editor_handler = new mn(this)),
      await this.editor_handler.setup(),
      (this.fuzzy_suggester = new Nr(this)),
      (this.event_handler = new hr(this, this.templater, this.settings)),
      this.event_handler.setup(),
      (this.command_handler = new on(this)),
      this.command_handler.setup(),
      (0, jr.addIcon)("templater-icon", oi),
      this.addRibbonIcon("templater-icon", "Templater", async () => {
        this.fuzzy_suggester.insert_template();
      }).setAttribute("id", "rb-templater-icon"),
      this.addSettingTab(new $r(this)),
  ...
  async load_settings() {
    this.settings = Object.assign({}, ri, await this.loadData());
  }
};
