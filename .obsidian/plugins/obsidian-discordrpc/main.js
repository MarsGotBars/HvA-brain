...
const { setTimeout: setTimeout$1, clearTimeout } =
  ...
  DiscordRPCSettingsTab.prototype.display = function () {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (boolean) {
        return boolean
          .setValue(plugin.settings.showVaultName)
    ...
    new obsidian.Setting(containerEl)
      ...
      .addText(function (text) {
        return text
          .setValue(plugin.settings.customVaultName)
          .onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (boolean) {
        boolean
          .setValue(plugin.settings.useLoadedTime)
          .onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (boolean) {
        boolean
          .setValue(plugin.settings.connectOnStart)
          .onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (boolean) {
        return boolean
          .setValue(plugin.settings.showPopups)
          .onChange(function (value) {
...
var ObsidianDiscordRPC = /** @class */ (function (_super) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            this.registerDomEvent(statusBarEl, "click", function () {
        ...
        switch (_a.label) {
          case 0:
            ...
            this.rpc.once("ready", function () {
              ...
              _this.statusBar.displayState(
                _this.getState(),
                _this.settings.autoHideStatusBar,
              );
              _this.logger.log(
                "Connected to Discord",
                _this.settings.showPopups,
              );
            });
            _a.label = 1;
          case 1:
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.setActivity(this.app.vault.getName(), "...", ""),
            ];
          case 3:
            _a.sent();
            return [3 /*break*/, 5];
  ...
  ObsidianDiscordRPC.prototype.setActivity = function (
    vaultName,
    fileName,
    fileExtension,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            if (
              !(
                this.settings.showVaultName && this.settings.showCurrentFileName
              )
            )
              return [3 /*break*/, 2];
            return [
